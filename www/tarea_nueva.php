						...
						<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
							<div class="card  box-shadow-0">
								<div class="card-header">
									<h4 class="card-title mb-1">Crear Tarea</h4>
									
								</div>
								<div class="card-body pt-0">
									<form class="form-horizontal"  action="create_tarea.php" method="post" >
										<div class="form-group">
											<input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre Tarea">
										</div>
										<div class="form-group">
											Fecha de Caducidad
										...
										<div class="input-group col-md-4">
											...
											</div><input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" type="text" id="fecha" name="fecha">
										</div>
									</div>
										</div>
										...
										<div class="form-group">
											<p class="mg-b-10">Asignar Usuario</p>
											<select class="form-control select2-no-search" id="projectinput6" name="id_usuario" >
										 <?php 
                                                      ...
                                                      // $mysqli = new mysqli("localhost", "goviccl1_cgsbim", "Paralelepipedo1674", "goviccl1_fmbim");
                                                       ...
                                                       $fila = "<option value='none' selected='' disabled=''>Seleccione Usuario</option>";
										...
										<div class="form-group">
											<p class="mg-b-10">Especialidad</p>
											<select class="form-control select2-no-search" id="projectinput7" name="especialidad">
										...
										<div class="form-group">
											Descripción
											<textarea class="form-control mg-t-20" placeholder="Descripción de la Tarea" id="descripcion" name="descripcion" required="" rows="3"></textarea>
										</div>
