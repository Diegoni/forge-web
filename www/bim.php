	...
	<div class="main-header sticky side-header nav nav-item">
				...
				<div class="container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
							<div>
							  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">Proyectos</h2>
							...
							<div class="card">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">LISTADO DE PROYECTOS</h4>
									...
									<div class="table-responsive">
										<table class="table mg-b-0 text-md-nowrap">
											...
											<tbody>
												<tr>
													<th scope="row">1</th>
													<td>Proyecto Muestra</td>
													<td><a href="nivel.html"><button class="btn btn-outline-success btn-block"  >Entrar</button></a></td>
													<td><button class="btn btn-outline-warning btn-block">Eliminar</button></td>
												</tr>
						...
						<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
							<div class="card  box-shadow-0 ">
								<div class="card-header">
									<h4 class="card-title mb-1">Añadir Proyecto</h4>
									...
									<form >
										<div class="">
											<div class="form-group">
												...
												<input type="email" class="form-control" id="exampleInputNombre" placeholder="Nombre">
											</div>
											<div class="form-group">
												<label for="exampleInputAnotaciones">Anotaciones</label>
												<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Ingrese Anotaciones (opcional)">
											</div>
                                            <div class="form-group">
			...
			<div class="main-footer ht-40">
				<div class="container-fluid pd-t-0-f ht-100p">
					<span>Copyright © 2020 <a href="#">ARBIM FM</a>. <a href="https://www.spruko.com/"></a></span>
				</div>
			</div>
			<!-- Footer closed -->
		...
		<script src="assets/plugins/perfect-scrollbar/p-scroll.js"></script>	<!--Internal Sparkline js -->
